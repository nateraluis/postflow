...
DEBUG = env("DEBUG")
ALLOWED_HOSTS = ['.amazonlightsail.com', 'localhost', '0.0.0.0', '127.0.0.1','https://postflow.pp347jb6gimu4.eu-central-1.cs.amazonlightsail.com','https://postflow.photo','https://www.postflow.photo']
