"""
URL configuration for Mastodon Analytics.
"""
from django.urls import path
from django.views.generic import RedirectView
from . import views

app_name = 'analytics_mastodon'

urlpatterns = [
    path('', views.dashboard, name='dashboard'),
    # Redirect top-engagers to engagement-distribution (unified view)
    path('top-engagers/', RedirectView.as_view(pattern_name='analytics_mastodon:engagement_distribution', permanent=True), name='top_engagers'),
