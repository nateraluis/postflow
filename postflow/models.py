...
class ScheduledPost(models.Model):
    ...
    poll_expires_in = models.PositiveIntegerField(blank=True, null=True, help_text="Poll duration in seconds (e.g. 86400 for 24h)")
    poll_multiple = models.BooleanField(default=False, help_text="Allow multiple poll choices")
    poll_hide_totals = models.BooleanField(default=False, help_text="Hide vote totals until poll ends")
