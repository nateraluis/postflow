...
urlpatterns = [
    ...
    path('thread/', views.thread_composer, name='thread_composer'),
    path('boost/', views.boost_scheduler, name='boost_scheduler'),
    path('followers/', views.follower_dashboard, name='follower_dashboard'),
    path('rss/', views.rss_feeds_view, name='rss_feeds'),
    path('rss/<int:feed_id>/delete/', views.delete_rss_feed, name='delete_rss_feed'),
